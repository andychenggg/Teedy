...
create memory table T_USER_REQUEST( USE_ID_C  varchar(36) not null, USE_USERNAME_C varchar(50) not null, USE_PASSWORD_C varchar(60) not null, USE_EMAIL_C varchar(100) not null, USE_STATUS_C varchar(20) not null  default 'PENDING', USE_STORAGEQUOTA_N bigint not null default 10000000000, primary key (USE_ID_C));
